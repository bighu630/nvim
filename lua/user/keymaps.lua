...
-- no highlight
keymap("n", "<leader><enter>", ":nohl<CR>", opts)
-- delete cur buffer
...
-- debug
keymap("n", "<space>db", "<cmd>lua require'dap'.toggle_breakpoint(); require'user.dap.dap-util'.store_breakpoints(true)<cr>", opts)
keymap("n", "<space>dB", "<cmd>lua require'dap'.set_breakpoint(vim.fn.input '[Condition] > ')<cr>", opts)
...
keymap("n", "S", ":w<enter>", opts)
-- 翻译
keymap("n", "T", "<cmd>TranslateW<enter>", opts)
keymap("v", "T", "<cmd>TranslateW<enter>", opts)
-- 跳转到下一个错误
